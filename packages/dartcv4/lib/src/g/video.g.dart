...
class CvNativeVideo {
  ...
  // --- TrackerCSRT / TrackerKCF -------------------------------------------
  // Hand-written to match the generated TrackerMIL bindings above; the C side
  // lives in the vendored dartcv snapshot under packages/dartcv_native.

  void cv_TrackerCSRT_close(
    TrackerCSRTPtr self,
  ) {
    return _cv_TrackerCSRT_close(
      self,
    );
  }

  late final _cv_TrackerCSRT_closePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(TrackerCSRTPtr)>>(
          'cv_TrackerCSRT_close');
  late final _cv_TrackerCSRT_close =
      _cv_TrackerCSRT_closePtr.asFunction<void Function(TrackerCSRTPtr)>();

  ffi.Pointer<CvStatus> cv_TrackerCSRT_create(
    ffi.Pointer<TrackerCSRT> rval,
  ) {
    return _cv_TrackerCSRT_create(
      rval,
    );
  }

  late final _cv_TrackerCSRT_createPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<CvStatus> Function(
              ffi.Pointer<TrackerCSRT>)>>('cv_TrackerCSRT_create');
  late final _cv_TrackerCSRT_create = _cv_TrackerCSRT_createPtr
      .asFunction<ffi.Pointer<CvStatus> Function(ffi.Pointer<TrackerCSRT>)>();

  ffi.Pointer<CvStatus> cv_TrackerCSRT_init(
    TrackerCSRT self,
    Mat image,
    CvRect bbox,
    imp$1.CvCallback_0 callback,
  ) {
    return _cv_TrackerCSRT_init(
      self,
      image,
      bbox,
      callback,
  ...
  late final _cv_TrackerCSRT_initPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<CvStatus> Function(TrackerCSRT, Mat, CvRect,
              imp$1.CvCallback_0)>>('cv_TrackerCSRT_init');
  late final _cv_TrackerCSRT_init = _cv_TrackerCSRT_initPtr.asFunction<
      ffi.Pointer<CvStatus> Function(
          TrackerCSRT, Mat, CvRect, imp$1.CvCallback_0)>();

  ffi.Pointer<CvStatus> cv_TrackerCSRT_update(
    TrackerCSRT self,
    Mat image,
    ffi.Pointer<CvRect> boundingBox,
    ffi.Pointer<ffi.Bool> rval,
  ...
  late final _cv_TrackerCSRT_updatePtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<CvStatus> Function(
              TrackerCSRT,
              Mat,
              ffi.Pointer<CvRect>,
              ffi.Pointer<ffi.Bool>,
              imp$1.CvCallback_0)>>('cv_TrackerCSRT_update');
  late final _cv_TrackerCSRT_update = _cv_TrackerCSRT_updatePtr.asFunction<
      ffi.Pointer<CvStatus> Function(TrackerCSRT, Mat, ffi.Pointer<CvRect>,
          ffi.Pointer<ffi.Bool>, imp$1.CvCallback_0)>();

  void cv_TrackerKCF_close(
    TrackerKCFPtr self,
  ) {
    return _cv_TrackerKCF_close(
      self,
    );
  }

  late final _cv_TrackerKCF_closePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(TrackerKCFPtr)>>(
          'cv_TrackerKCF_close');
  late final _cv_TrackerKCF_close =
      _cv_TrackerKCF_closePtr.asFunction<void Function(TrackerKCFPtr)>();

  ffi.Pointer<CvStatus> cv_TrackerKCF_create(
    ffi.Pointer<TrackerKCF> rval,
  ) {
    return _cv_TrackerKCF_create(
      rval,
    );
  }

  late final _cv_TrackerKCF_createPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<CvStatus> Function(
              ffi.Pointer<TrackerKCF>)>>('cv_TrackerKCF_create');
  late final _cv_TrackerKCF_create = _cv_TrackerKCF_createPtr
      .asFunction<ffi.Pointer<CvStatus> Function(ffi.Pointer<TrackerKCF>)>();

  ffi.Pointer<CvStatus> cv_TrackerKCF_init(
    TrackerKCF self,
    Mat image,
    CvRect bbox,
    imp$1.CvCallback_0 callback,
  ) {
    return _cv_TrackerKCF_init(
      self,
      image,
      bbox,
      callback,
  ...
  late final _cv_TrackerKCF_initPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<CvStatus> Function(TrackerKCF, Mat, CvRect,
              imp$1.CvCallback_0)>>('cv_TrackerKCF_init');
  late final _cv_TrackerKCF_init = _cv_TrackerKCF_initPtr.asFunction<
      ffi.Pointer<CvStatus> Function(
          TrackerKCF, Mat, CvRect, imp$1.CvCallback_0)>();

  ffi.Pointer<CvStatus> cv_TrackerKCF_update(
    TrackerKCF self,
    Mat image,
    ffi.Pointer<CvRect> boundingBox,
    ffi.Pointer<ffi.Bool> rval,
  ...
  late final _cv_TrackerKCF_updatePtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<CvStatus> Function(
              TrackerKCF,
              Mat,
              ffi.Pointer<CvRect>,
              ffi.Pointer<ffi.Bool>,
              imp$1.CvCallback_0)>>('cv_TrackerKCF_update');
  late final _cv_TrackerKCF_update = _cv_TrackerKCF_updatePtr.asFunction<
      ffi.Pointer<CvStatus> Function(TrackerKCF, Mat, ffi.Pointer<CvRect>,
          ffi.Pointer<ffi.Bool>, imp$1.CvCallback_0)>();
...
class _SymbolAddresses {
  ...
  ffi.Pointer<ffi.NativeFunction<ffi.Void Function(TrackerCSRTPtr)>>
      get cv_TrackerCSRT_close => _library._cv_TrackerCSRT_closePtr;
  ffi.Pointer<ffi.NativeFunction<ffi.Void Function(TrackerKCFPtr)>>
      get cv_TrackerKCF_close => _library._cv_TrackerKCF_closePtr;
}
...
final class TrackerCSRT extends ffi.Struct {
  external ffi.Pointer<ffi.Void> ptr;
}

typedef TrackerCSRTPtr = ffi.Pointer<TrackerCSRT>;

final class TrackerKCF extends ffi.Struct {
  external ffi.Pointer<ffi.Void> ptr;
}

typedef TrackerKCFPtr = ffi.Pointer<TrackerKCF>;
